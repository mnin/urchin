...
window.___jsl.h=window.___jsl.h||'m;\/_\/apps-static\/_\/js\/gapi\/__features__\/rt=j\/ver=jGBELoxL5Y8.de.\/sv=1\/am=!Ze6NnRS0VYCICGRMrA\/d=1';
window.___jsl.l=[];
window.___gpq=[];
...
window.gapi.plus=window.gapi.plus||(function(){
  ...
  return{go:f('go'),render:f('render')}})();
window['___jsl'] = window['___jsl'] || {};window['___jsl']['uc'] = 'https:\/\/plusone.google.com\/js\/plusone.js';window['___jsl']['u'] = 'https:\/\/plusone.google.com\/js\/plusone.js';window['___jsl']['f'] = ['plusone-unsupported'];(window['___jsl']['ci'] = (window['___jsl']['ci'] || [])).push({"lexps":[33,38,36,43,40,47,15,45,17,50,54,52,58,56,30],"report":{},"iframes":{":socialhost:":"https://plusone.google.com",":signuphost:":"https://plus.google.com"},"isPlusUser":false});var gapi=window.gapi||{};gapi.client=window.gapi&&window.gapi.client||{};
window.gapi=window.gapi||{};
